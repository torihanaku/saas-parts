...
- `dev-dashboard-v2/server/lib/tenant-secrets.ts` (~246 LOC, #991 Phase 4)
- 暗号関数: `dev-dashboard-v2/server/lib/token.ts` の encrypt/decrypt（プライベートコピー）
- legacy 平文互換: `dev-dashboard-v2/server/lib/nango-client.ts` の readStoredSecret パターン
- テスト移植元: `dev-dashboard-v2/tests/tenant-secrets.test.ts`
