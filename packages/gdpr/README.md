...
- `dev-dashboard-v2/server/lib/gdpr-executor.ts`（約277行）
- `dev-dashboard-v2/server/lib/gdpr-exporter.ts`（約86行）
- テスト出典: `dev-dashboard-v2/tests/gdpr-executor.test.ts` / `tests/gdpr-executor-cascade.test.ts` / `tests/gdpr-exporter.test.ts`
